...
<body>
    <form id="form1" runat="server">
        <div style="margin-left:auto;margin-right:auto;" class="auto-style1">
            ...
            <asp:ImageButton ID="tsbCliente" runat="server" Height="104px" ImageUrl="~/Resources/person_user_customer_man_male_man_boy_people_1687.png" Width="90px" />
            &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ImageButton ID="tsbConductor" runat="server" Height="104px" ImageUrl="~/Resources/taxi_18540.png" Width="90px" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:ImageButton ID="tsbTarifa" runat="server" Height="104px" ImageUrl="~/Resources/construction_project_plan_building_architect_design_develop-73_icon-icons.com_60243.png" Width="90px" OnClick="tsbTarifa_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:ImageButton ID="tsbCarrera" runat="server" Height="104px" ImageUrl="~/Resources/Ticket_icon-icons.com_54128.png" Width="90px" />
        ...
        <div style="margin-left:auto;margin-right:auto;" class="auto-style3">
            ...
            <asp:GridView ID="dgv" runat="server" AutoGenerateColumns="False" Height="96px" Width="481px">
                <Columns>
                    <asp:BoundField HeaderText="idTarifa" Visible="False" />
                    <asp:BoundField HeaderText="Numero" />
                    <asp:BoundField HeaderText="Bandera" />
                    <asp:BoundField HeaderText="Duración" />
                    <asp:BoundField HeaderText="Metros" />
                </Columns>
            </asp:GridView>
