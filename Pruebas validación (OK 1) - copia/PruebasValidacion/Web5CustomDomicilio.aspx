...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br class="auto-style1" />
        <br class="auto-style1" />
        <asp:ImageButton ID="ibtnEnviar" runat="server" ClientValidationFunction="ValidaCP" Height="129px" ImageUrl="~/Imagenes/formulario.png" Width="168px" OnClick="ibtnEnviar_Click" />
